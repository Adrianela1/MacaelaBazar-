...
-- -----------------------------------------------------
-- Table `macaela`.`Order_tatus`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `macaela`.`Order_tatus` (
  ...
  CONSTRAINT `fk_Order_tatus_Orders1`
    ...
    REFERENCES `macaela`.`Orders` (`order_id` , `Users_User_id` , `Place_delivery_place_delivery_id` , `pay_pst_id` , `Product_Product_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
